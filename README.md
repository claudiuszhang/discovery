...
[![Go Report Card](https://goreportcard.com/badge/github.com/claudiuszhang/discovery)](https://goreportcard.com/report/github.com/claudiuszhang/discovery)
...
```shell
cd $GOPATH/src
git clone https://github.com/claudiuszhang/discovery.git
